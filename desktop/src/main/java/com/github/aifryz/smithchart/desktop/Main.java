...
public class Main extends Application{
    ...
    public void start(Stage primaryStage){
        try {
            ...
            model.m_elements.add(new ChartElement(0.1));
            model.m_elements.add(new ChartElement(1));
            model.m_elements.add(new ChartElement(10));
            model.m_elements.add(new ChartElement(50));
            model.m_elements.add(new ChartElement(100));
            model.m_elements.add(new ChartElement(200));
